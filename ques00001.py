...
combinations = list(itertools.combinations(listarray,2))
# print(combinations)

k=0
def caculateAnswer(array,listarray,combinations,k):
    if k ==0:
        print(f"LeedCode Question:")
        print(f"initarray= {array}")
        print(f"listarray= {listarray}")
    ...
    for combination in combinations:
        k += 1
        print(f"=========it's {k} times=========")
        num1 = array[combination[0]]
        num2 = array[combination[1]]
        print(num1,num2)
        if num1 + num2 == answer:
            print(f"cuz num1 + num2 = answer = {answer}, stop method")
            print(f"answer= {combination}")
            print(f"num1= {num1}, sequence in array= {combination[0]}")
            print(f"num2= {num2}, sequence in array= {combination[1]}")
            break
        else:
            continue

caculateAnswer(array,listarray,combinations,k)